...
function Proxy(target, handler, revocable) {
  ...
  Object.defineProperty(this, "__lookupGetter__", {
    value: target.__lookupSetter__.bind(target),
  });
  Object.defineProperty(this, "__lookupSetter__", {
    value: target.__lookupSetter__.bind(target),
  });
  Object.defineProperty(this, "__defineGetter__", {
    value: target.__defineGetter__.bind(target),
  });
  Object.defineProperty(this, "__defineSetter__", {
    value: target.__defineSetter__.bind(target),
  });
  ...
  Object.defineProperty(this, "__proto__", {
    get: function () {
      if ("getPrototypeOf" in handler) return handler.getPrototypeOf(target);
      else return target.__proto__;
    },
    set: function (val) {
      if ("setPrototypeOf" in handler) handler.setPrototypeOf(target, val);
      else target.__proto__ = val;
    },
  ...
  Object.defineProperty(this, "apply", {
    value: function () {
      ...
      else return target.apply.apply(this == self ? target : this, arguments);
    },
  });

  //for handler.has (not a full implementation, but as good as I could do)
  Object.defineProperty(this, "hasOwnProperty", {
        ...
        if (change.type == "add") {
          if ("defineProperty" in handler) {
            ...
            Object.defineProperty(
              target,
              change.name,
              Object.getOwnPropertyDescriptor(this, change.name)
            );
  ...
  for (var key in target) bind(key);
